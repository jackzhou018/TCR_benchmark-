...
recognition of foreign antigens. This recognition is mediated by T cell receptors (TCRs) 
which bind to certain peptide-major histocompatibility complex (pMHC) molecules 
presented on the surface of target cells. The specificity of TCR-pMHC interactions 
is determined by the structural complementarity between the TCR and the pMHC.
...
Unfortunately, experimental determination of TCR-pMHC complexes 
remains slow relative to the size of the repertoire, so
...
predictions {[}4{]}, though early benchmarks identified adaptive immune
recognition, inluding TCR--pMHC complexes,as a point of weakness {[}5{]}. 
AlphaFold 3 replaced the structure Module with a diffusion head, substantially
improving the interface accuracy across biomolecular space {[}6{]}, and
...
that guide the prediction process using coevolutionary information. However, protein language models have made 
...
information within its representations [9], replacing evolutionary 
...
accurate on complex multi-chain structures, including TCR--pMHC complexes. 
...
a more diverse set of geometrically plausible docking configurations. 
...
increase in use of diffusion-based models, it is becoming easier to
...
biological structure using a variety of metrics including interface accuracy (DockQ), TCR-specific
...
ESMFold2 {[}21{]} was run through the ESM SDK
