...
run at default sampler settings on one RTX PRO 6000 (Section 2.10).
...
biological sequence with ANARCI [35] under IMGT numbering [36],
...
56--65 (CDR2), 81--86 (CDR2.5) and 104--118 (CDR3), the same intervals
used by Woods et al. [37]; ``all CDRs'' means all four regions on both
chains, eight in total.
...
\subsection{2.10 Sampler instrumentation and
...
\subsection{2.11 Statistics and software}\label{statistics-and-software}
