...
It is the best of the reference-free scores on this benchmark (Figure
4B). On the same 126 complexes the published random-forest quality-tier
...
Global DockQ for every reference-free score over all 126 complexes;
