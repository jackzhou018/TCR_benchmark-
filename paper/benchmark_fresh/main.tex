...
with an initial RCSB {[}37{]} release date after 30 September 2021 gave 427 class
...
these complexes from sequence alone is not well posed. Four (8VD0, 8VQ8,
9AUD, 9C3E) are engineered constructs in which the peptide is covalently
fused to the MHC through a linker; modelling their components as
separate chains would alter the connectivity of the experiment. The
last, 9J4S, has no physical TCR--pMHC interface in any author-defined
assembly of the deposited structure and so cannot be scored at all
(Section 2.3). This leaves 126 scoreable complexes, 111 class I and 15 class
II.
